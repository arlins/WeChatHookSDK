...
@property (nonatomic, assign) int cgiCmdid; // @dynamic cgiCmdid;
@property (nonatomic, assign) int errorType; // @dynamic errorType;
...
@interface SettingMyProfileViewController : UIViewController
...
@property (nonatomic, strong) NSString *nsOldText;
...
- (unsigned int)uploadHDHeadImg:(UIImage *)arg1 qualityType:(unsigned int)arg2;
- (unsigned int)uploadHDHeadImg:(UIImage *)arg1;
