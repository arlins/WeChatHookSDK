...
@interface WXHongBaoHitConfigViewController () <UITableViewDataSource, UITableViewDelegate, WXHongBaoSettingCellDelegate>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation WXHongBaoHitConfigViewController
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if ( buttonIndex == 1 && [alertView isKindOfClass:[HKAlertView class]] )
    {
        ...
        WXHongBaoRuleHandler *handler = [[WXHongBaoRuleManager shareInstance] ruleHandlerOfStyle:WXHongBaoRuleStyleHit] ;
